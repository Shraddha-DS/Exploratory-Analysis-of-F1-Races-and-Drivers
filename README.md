# Basic exploratory analysis of F1 races and the drivers (till 2023 Data)
...
## Data Source
The data is obtained from Kaggle. The dataset contains information about F1 drivers , seasons competed , race data and points earned.
